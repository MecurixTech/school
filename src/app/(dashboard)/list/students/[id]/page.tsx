...
const MOCK_CLASSES: Class[] = [
  { id: "c1", name: "Primary 1", _count: { lessons: 12 } },
];
...
const SingleStudentPage = ({ params: { id } }: SingleStudentPageProps) => {
  const role = "admin"; // Hardcoded for demo purposes

  // In real scenario, you would fetch the student by id. For now, just use MOCK_STUDENT
